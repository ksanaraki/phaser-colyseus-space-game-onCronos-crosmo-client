...
class MultiplayerScene extends Phaser.Scene {
	...
	initWorld() {
		...
		//this.physics.add.overlap(this._bullets, this._myShip, this.shipBulletCollision, null, this)
	}
	...
	updateBulletLaunchDataToserver(x: number, y: number, rotation: number, speed: number, shooter: any,teamflag:number) {
		...
		console.log("ask bullet (", shooter._bulletType, shooter, ")at : ", new Date().getTime());
